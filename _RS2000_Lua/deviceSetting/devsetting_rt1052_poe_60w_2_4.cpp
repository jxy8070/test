#include "stable.h"
#include "devsetting_rt1052_poe_60w_2_4.h"
...
// 构造函数
DevSetting_RT1052_Poe_60W_2_4::DevSetting_RT1052_Poe_60W_2_4(DeviceItem_RT1052_Poe_60W_2_4 *devItem,  QWidget *parent) :
    DevSettingDlg(parent),
#ifdef Logo_BeiJingHuiSheng
    ui(new Ui::DevSetting_RT1052_Poe_60W_2_4_Ceiadap)
#else
    ui(new Ui::DevSetting_RT1052_Poe_60W_2_4)
#endif
{
    ui->setupUi(this);
    _devItem = devItem;
...
DevSetting_RT1052_Poe_60W_2_4::~DevSetting_RT1052_Poe_60W_2_4()
{
    _devAmp->sendStopMonitor();
    delete ui;
}

void DevSetting_RT1052_Poe_60W_2_4::connectSigSlots()
{
    /* 从设备初始化界面 */
...
#ifdef Logo_BeiJingHuiSheng
    connect(ui->com_mixerMode, SIGNAL(currentIndexChanged(int)), this, SLOT(mixerModeChangedSlot(int)));
#endif
}

void DevSetting_RT1052_Poe_60W_2_4::displayConfigValue()
{
...
#ifdef Logo_BeiJingHuiSheng
    ui->com_mixerMode->setCurrentIndex(cfgData.mixer_mode);
    ui->AOut_Mixter->setDisabled(cfgData.mixer_mode);
#endif
...
/* Gain\Mute\Phase\Delay */
void DevSetting_RT1052_Poe_60W_2_4::setGain(int value)
{
...
void DevSetting_RT1052_Poe_60W_2_4::setMute(bool enable)
{
...
void DevSetting_RT1052_Poe_60W_2_4::setPhase(bool enable)
{
...
void DevSetting_RT1052_Poe_60W_2_4::setDelay(int value)
{
    quint16 remain = MAX_DELAY_TIME
...
/* Eq */
void DevSetting_RT1052_Poe_60W_2_4::setEq()
{
    int channel;
    EqData4B eq4B;
    EqData15B eq15B;
...
/* 处理函数 */
void DevSetting_RT1052_Poe_60W_2_4::onChannelEqChanged(quint8 ch, bool bypass, EqData *eqPara)
{
...
void DevSetting_RT1052_Poe_60W_2_4::onEqChanged(quint8 ch, bool bypass, EqData *eqPara)
{
    _devAmp->sendEq(1, ch, bypass, eqPara);
}

/* Dyn */
void DevSetting_RT1052_Poe_60W_2_4::setDyn()
{
    int channel;
    DynData dynData;
...
/* 处理函数 */
void DevSetting_RT1052_Poe_60W_2_4::onDynChanged(quint8 ch, bool isIn ,DynData dynData)
{
    _devAmp->sendDyn(ch, dynData);
}

/* XOVER */
void DevSetting_RT1052_Poe_60W_2_4::setXOver()
{
    quint8 ch = 0;
...
void DevSetting_RT1052_Poe_60W_2_4::onXoverChanged(uint8_t ch, ConfigData_Xover xData)
{
    _devAmp->sendXover(ch, xData.bypass, xData.freq[0], xData.freq[1], xData.stages[0], xData.stages[1]);
}

#ifdef Logo_BeiJingHuiSheng
void DevSetting_RT1052_Poe_60W_2_4::mixerModeChangedSlot(int idx)
{
    ui->AOut_Mixter->setDisabled(idx);
    _devAmp->sendMixerMode(idx);
}
#endif

/* AOut Mixer */
void DevSetting_RT1052_Poe_60W_2_4::setAOutMixer()
{
...
void DevSetting_RT1052_Poe_60W_2_4::MixerChangedSlot(int out, int in, bool enable)
{
    _devAmp->sendMixer(out, in, enable);
}

void DevSetting_RT1052_Poe_60W_2_4::DisplaySlot(struct MsgData_RT1052_Poe b)
{
...
//// 另存场景为文件
//void DevSetting_RT1052_Poe_60W_2_4::on_saveAsBtn_clicked()
//{
...
//// 加载场景文件
//void DevSetting_RT1052_Poe_60W_2_4::on_loadBtn_clicked()
//{
...
void DevSetting_RT1052_Poe_60W_2_4::on_save_clicked()
{
    _devAmp->sendSave();
}
