#ifndef DEVSETTING_AMP_QUAD_H
#define DEVSETTING_AMP_QUAD_H
...
namespace Ui {
class DevSetting_Amp_Quad;
}
class DevSetting_Amp_Quad : public DevSettingDlg
{
    Q_OBJECT
public:
    DevSetting_Amp_Quad(DeviceItem_Amp_Quad *devItem, QWidget *parent = 0);
    ~DevSetting_Amp_Quad();
