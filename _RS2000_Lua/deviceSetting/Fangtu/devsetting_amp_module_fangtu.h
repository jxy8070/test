#ifndef DEVSETTING_AMP_MODULE_FANGTU_H
#define DEVSETTING_AMP_MODULE_FANGTU_H
...
namespace Ui {
class DevSetting_Amp_Module_FangTu;
}


class DevSetting_Amp_Module_FangTu : public DevSettingDlg
{
    Q_OBJECT

public:
    explicit DevSetting_Amp_Module_FangTu(DeviceItem_RT1052_AMP_MODULE_4_4 *devItem, QWidget *parent = 0);
    ~DevSetting_Amp_Module_FangTu();
private slots:
...
#define MAX_DELAY_TIME      200*48
    Ui::DevSetting_Amp_Module_FangTu *ui;
    DeviceItem_RT1052_AMP_MODULE_4_4 *_devItem;
    Device_Amp_Module *_devAmp;
};


#endif // DEVSETTING_AMP_MODULE_FANGTU_H
