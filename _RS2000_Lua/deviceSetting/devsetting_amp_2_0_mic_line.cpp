#include "stable.h"
#include "devsetting_amp_2_0_mic_line.h"
...
// 构造函数
DevSetting_Amp_2_0_Mic_Line::DevSetting_Amp_2_0_Mic_Line(DeviceItem_Amp_2_0_Mic_Line *devItem,  QWidget *parent) :
    DevSettingDlg(parent),
    ui(new Ui::DevSetting_Amp_2_0_Mic_Line)
{
    ui->setupUi(this);
    _devItem = devItem;
...
DevSetting_Amp_2_0_Mic_Line::~DevSetting_Amp_2_0_Mic_Line()
{
    _dev->sendStopMonitor();
    delete ui;
}

void DevSetting_Amp_2_0_Mic_Line::connectSigSlots()
{
    /* 从设备初始化界面 */
...
void DevSetting_Amp_2_0_Mic_Line::displayConfigValue()
{
...
void DevSetting_Amp_2_0_Mic_Line::MicGainChanged(int value)
{
...
void DevSetting_Amp_2_0_Mic_Line::MicPhantomChanged(bool enable)
{
...
void DevSetting_Amp_2_0_Mic_Line::GainChanged(int value)
{
    int ch = 0;
    if (sender() == ui->gain_1)
    {
...
void DevSetting_Amp_2_0_Mic_Line::setMute(bool enable)
{
...
void DevSetting_Amp_2_0_Mic_Line::xoverClicked()
{
    int ch = 0;
...
void DevSetting_Amp_2_0_Mic_Line::DynClicked()
{
    int channel;
...
void DevSetting_Amp_2_0_Mic_Line::onDynChanged(quint8 ch, bool isIn ,DynData dynData)
{
    _dev->sendDyn(ch, dynData);
}

void DevSetting_Amp_2_0_Mic_Line::EqClicked()
{
    int channel;
...
void DevSetting_Amp_2_0_Mic_Line::onEqChanged(quint8 ch, bool bypass, EqData *eqPara)
{
    _dev->sendEq(ch, bypass, eqPara);
}

void DevSetting_Amp_2_0_Mic_Line::OutPhaseClicked(bool enable)
{
    int ch = 0;
...
void DevSetting_Amp_2_0_Mic_Line::MixerClicked()
{
    if (sender() == ui->Mixer)
    {
...
void DevSetting_Amp_2_0_Mic_Line::OutGainChanged(int value)
{
    int ch = 0;
...
void DevSetting_Amp_2_0_Mic_Line::DisplaySlot(MsgData_Amp_2_0_Mic_Line b)
{
...
void DevSetting_Amp_2_0_Mic_Line::micOpenClicked(bool d)
{
...
void DevSetting_Amp_2_0_Mic_Line::on_save_clicked()
{
    _dev->sendSave();
}
