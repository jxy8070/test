#include "amp_0_2_Line_mixer.h"
#include "ui_amp_0_2_Line_mixer.h"
#include "device/device_amp_0_2_line.h"

Amp_0_2_Line_Mixer::Amp_0_2_Line_Mixer(Device_Amp_0_2_Line *devAmp, QWidget *parent) :
    DevSettingDlg(parent),
    ui(new Ui::Amp_0_2_Line_Mixer)
{
    ui->setupUi(this);

    _devAmp = devAmp;
    ConfigData_RT1052_Mixer_2_2 mix = _devAmp->getConfigData().Aout_mixer;
...
Amp_0_2_Line_Mixer::~Amp_0_2_Line_Mixer()
{
    delete ui;
}

void Amp_0_2_Line_Mixer::pb_clicked(bool enable)
{
    quint8 in = 0, out = 0;
