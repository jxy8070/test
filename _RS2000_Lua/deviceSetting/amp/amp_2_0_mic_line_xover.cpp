#include "amp_2_0_mic_Line_xover.h"
#include "ui_amp_2_0_mic_Line_xover.h"
#include "device/device_amp_2_0_mic_line.h"

Amp_2_0_Mic_Line_xover::Amp_2_0_Mic_Line_xover(Device_Amp_2_0_Mic_Line *devAmp, quint8 ch, QWidget *parent) :
    DevSettingDlg(parent),
    ui(new Ui::Amp_2_0_Mic_Line_xover)
{
    ui->setupUi(this);
    _devAmp = devAmp;
    _ch = ch;
    ConfigData_Xover xover = _devAmp->getConfigData().xover[ch];
...
Amp_2_0_Mic_Line_xover::~Amp_2_0_Mic_Line_xover()
{
    delete ui;
}

void Amp_2_0_Mic_Line_xover::pb_clicked(bool enable)
{
    if (sender() == ui->bypass)
    {
...
void Amp_2_0_Mic_Line_xover::valueChanged(int value)
{
...
void Amp_2_0_Mic_Line_xover::currentIndexChanged(int value)
{
