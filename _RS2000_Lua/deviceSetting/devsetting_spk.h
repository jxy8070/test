#ifndef DEVSETTING_SPK_H
#define DEVSETTING_SPK_H
...
/////////////////////////////////////////////
/// \brief DevSetting_SPK 音箱控制界面
/////////////////////////////////////////////
class DevSetting_Spk : public DevSettingDlg
{
    Q_OBJECT
public:
    DevSetting_Spk(DeviceItem_Spk *devItem, QWidget *parent = 0);
    ~DevSetting_Spk();
