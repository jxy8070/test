#include "stable.h"
#include "devsetting_amp_0_2_line.h"
#include "ui_devsetting_amp_0_2_line.h"
...
// 构造函数
DevSetting_Amp_0_2_Line::DevSetting_Amp_0_2_Line(DeviceItem_Amp_0_2_Line *devItem,  QWidget *parent) :
    DevSettingDlg(parent),
    ui(new Ui::DevSetting_Amp_0_2_Line)
{
    ui->setupUi(this);
    _devItem = devItem;
...
DevSetting_Amp_0_2_Line::~DevSetting_Amp_0_2_Line()
{
    _devAmp->sendStopMonitor();
    delete ui;
}

void DevSetting_Amp_0_2_Line::connectSigSlots()
{
    /* 从设备初始化界面 */
...
void DevSetting_Amp_0_2_Line::displayConfigValue()
{
...
/* Gain\Mute\Phase\Delay */
void DevSetting_Amp_0_2_Line::setGain(int value)
{
    quint8 type = 0, ch = 0;
...
void DevSetting_Amp_0_2_Line::setMute(bool enable)
{
    quint8 type = 0, ch = 0;
...
void DevSetting_Amp_0_2_Line::setPhase(bool enable)
{
    quint8 ch = 0;
...
void DevSetting_Amp_0_2_Line::setDelay(int value)
{
    quint8 ch = 0;
    quint16 remain = MAX_DELAY_TIME
            - ui->AIn1_Delay->value()
...
/* Eq */
void DevSetting_Amp_0_2_Line::setEq()
{
    int channel;
...
/* 处理函数 */
void DevSetting_Amp_0_2_Line::onEqChanged(quint8 ch, bool bypass, EqData *eqPara)
{
    _devAmp->sendEq(ch, bypass, eqPara);
}

/* Dyn */
void DevSetting_Amp_0_2_Line::setDyn()
{
    int channel;
...
/* 处理函数 */
void DevSetting_Amp_0_2_Line::onDynChanged(quint8 ch, bool isIn ,DynData dynData)
{
    _devAmp->sendDyn(ch, dynData);
}

/* XOVER */
void DevSetting_Amp_0_2_Line::setXOver()
{
    quint8 ch = 0;
...
/* AOut Mixer */
void DevSetting_Amp_0_2_Line::setAOutMixer()
{
...
void DevSetting_Amp_0_2_Line::DisplaySlot(MsgData_Amp_0_2_Line b)
{
...
//// 另存场景为文件
//void DevSetting_Amp_0_2_Line::on_saveAsBtn_clicked()
//{
...
//// 加载场景文件
//void DevSetting_Amp_0_2_Line::on_loadBtn_clicked()
//{
...
void DevSetting_Amp_0_2_Line::on_save_clicked()
{
    _devAmp->sendSave();
}
