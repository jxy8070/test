...
enum conmon_audinate_message_version
{
	...
	*/
	...
	/** The current version */
	CONMON_AUDINATE_MESSAGE_VERSION = CONMON_AUDINATE_MESSAGE_VERSION_0_7_38
};
...
enum conmon_audinate_message_type
{
	...
	*/
	...
	/**
	* Status of AES67 mode (enabled/dsiabled) for a Dante device
	*
	* Format: conmon_audinate_aes67_control
	* Channel: Status
	*/
...
/**
	...
	@param aud_msg Initialised upgrade control message
	@param manufactuer If non-null, apply upgrade as if the manufacturer field
		had this value
...
(
	conmon_message_body_t * aud_msg,
	const dante_id64_t * manfacturer,
