 ...
 */
typedef struct db_browse_aes67 db_browse_aes67_t;
...
typedef enum
{
	...
	/** AES67 Devices
	 * @note AES67 flows will not be discovered when browsing a Dante Domain
	 */
...
{
	DB_NODE_TYPE_DEVICE,
	DB_NODE_TYPE_CHANNEL,
	DB_NODE_TYPE_LABEL,
	DB_NODE_TYPE_AES67_SAP
} db_node_type_t;
