...
/**
 * Delete a browse object. Stops the mDNS browse action and frees all
...
/**
 * Start browsing using default settings. This functions begins the mDNS browse actions
 ...
 * This functions begins the mDNS browse actions
 * required to discover the information of interest for this browse.
 *
 * @param browse core browsing object
...
/**
 * Stop a browse. This function terminates the mDNS browse actions.
 *
 * @param browse core browsing object
 */
void
