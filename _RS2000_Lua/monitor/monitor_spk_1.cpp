...
Monitor_Spk_1::Monitor_Spk_1(Device_Spk_1 *devSpk, DeviceItem *devItem, QWidget *parent) :
    QGroupBox(parent),
...
Monitor_Spk_1::~Monitor_Spk_1()
{
    delete ui;
}

void Monitor_Spk_1::unLivingDectect()
{
...
void Monitor_Spk_1::showEvent(QShowEvent *)
{
...
void Monitor_Spk_1::hideEvent(QHideEvent *)
{
    _livingTimer->stop();
...
void Monitor_Spk_1::syncVolumeChanged()
{
    _syncing = true;
...
void Monitor_Spk_1::syncMuteChanged()
{
    _syncing = true;
...
void Monitor_Spk_1::syncPhaseChanged()
{
    _syncing = true;
...
void Monitor_Spk_1::syncRouterChanged()
{
    ui->InputSource->setText(_devSpk->getRouterInfo());
}

void Monitor_Spk_1::pushButtonSetText(QPushButton *pb, bool flag)
{
    if (flag)
    {
        pb->setText(tr("On"));
...
void Monitor_Spk_1::onAdcDataChanged(AlarmConfig *alarmCfg)
{
...
void Monitor_Spk_1::setIntValueDisplay(int i)
{
    /* 同步的时候不再次发送数据 */
    if (_syncing)
    {
...
void Monitor_Spk_1::setSliderValue()
{
    /* 同步的时候不再次发送数据 */
    if (_syncing)
    {
...
void Monitor_Spk_1::processPbClicked(bool flag)
{
