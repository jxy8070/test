#ifndef MONITOR_SPK_1_H
#define MONITOR_SPK_1_H
...
class Monitor_Spk_1 : public QGroupBox
{
    Q_OBJECT
public:
    explicit Monitor_Spk_1(Device_Spk_1 *devSpk, DeviceItem *devItem, QWidget *parent = 0);
    ~Monitor_Spk_1();
