#ifndef DEVICE_SPK_2_H
#define DEVICE_SPK_2_H

#include "dantedevice.h"
#include "protocal/packet.h"

class AlarmConfig;
class Device_Spk_2 : public DanteDevice
{
    Q_OBJECT
public:
    Device_Spk_2(const DanteDevice* danteDev);
    Device_Spk_2(QString mac, DevType devType, QString customName, QString serial);
