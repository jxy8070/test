#include "cfgsettingautomaticmixerGainSharing8.h"
#include "ui_cfgsettingautomaticmixerGainSharing8.h"
...
CfgSettingAutomaticMixerGainSharing8::CfgSettingAutomaticMixerGainSharing8(ConfigItemAutomaticMixer *cfgItem, QWidget *parent) :
    QWidget(parent),
    ui(new Ui::CfgSettingAutomaticMixerGainSharing8)
{
    _cfgItem = cfgItem;
    ui->setupUi(this);
...
CfgSettingAutomaticMixerGainSharing8::~CfgSettingAutomaticMixerGainSharing8()
{
    delete ui;
}

void CfgSettingAutomaticMixerGainSharing8::updateUiData()
{
...
void CfgSettingAutomaticMixerGainSharing8::initData()
{
    ui->Slider_ThreadLevel->setValue(_cfgItem->GetThreadLevel());
    ui->label_Threshold->setText(QString::asprintf("%d dB", ui->Slider_ThreadLevel->value()));
    ui->Slider_AttackTime->setValue(_cfgItem->GetAttackTime());
    ...
    connect(ui->Slider_PreInGain_5, SIGNAL(valueChanged(int)), this, SLOT(slider_valueChanged(int)));
    connect(ui->Slider_PreInGain_6, SIGNAL(valueChanged(int)), this, SLOT(slider_valueChanged(int)));
    connect(ui->Slider_PreInGain_7, SIGNAL(valueChanged(int)), this, SLOT(slider_valueChanged(int)));
    connect(ui->Slider_PreInGain_8, SIGNAL(valueChanged(int)), this, SLOT(slider_valueChanged(int)));
    ...
    connect(ui->PB_InputMute_5, SIGNAL(clicked(bool)), this, SLOT(pb_clicked(bool)));
    connect(ui->PB_InputMute_6, SIGNAL(clicked(bool)), this, SLOT(pb_clicked(bool)));
    connect(ui->PB_InputMute_7, SIGNAL(clicked(bool)), this, SLOT(pb_clicked(bool)));
    connect(ui->PB_InputMute_8, SIGNAL(clicked(bool)), this, SLOT(pb_clicked(bool)));
...
void CfgSettingAutomaticMixerGainSharing8::slider_valueChanged(int value)
{
//    QSlider *obj = qobject_cast<QSlider *>(sender());
    ...
    } else if (sender() == ui->Slider_PreInGain_5) {
        _cfgItem->SetPreInGain(ConfigItemAutomaticMixer::INPUT_CH5, value);
        ui->label_input5->setText(QString::asprintf("%d dB", ui->Slider_PreInGain_5->value()));
    } else if (sender() == ui->Slider_PreInGain_6) {
        _cfgItem->SetPreInGain(ConfigItemAutomaticMixer::INPUT_CH6, value);
        ui->label_input6->setText(QString::asprintf("%d dB", ui->Slider_PreInGain_6->value()));
    } else if (sender() == ui->Slider_PreInGain_7) {
        _cfgItem->SetPreInGain(ConfigItemAutomaticMixer::INPUT_CH7, value);
        ui->label_input7->setText(QString::asprintf("%d dB", ui->Slider_PreInGain_7->value()));
    } else if (sender() == ui->Slider_PreInGain_8) {
        _cfgItem->SetPreInGain(ConfigItemAutomaticMixer::INPUT_CH8, value);
        ui->label_input8->setText(QString::asprintf("%d dB", ui->Slider_PreInGain_8->value()));
...
void CfgSettingAutomaticMixerGainSharing8::pb_clicked(bool enable)
{
//    QPushButton *obj = qobject_cast<QPushButton *>(sender());
    ...
    } else if (sender() == ui->PB_InputMute_5) {
        _cfgItem->SetInputMute(ConfigItemAutomaticMixer::INPUT_CH5, enable);
    } else if (sender() == ui->PB_InputMute_6) {
        _cfgItem->SetInputMute(ConfigItemAutomaticMixer::INPUT_CH6, enable);
    } else if (sender() == ui->PB_InputMute_7) {
        _cfgItem->SetInputMute(ConfigItemAutomaticMixer::INPUT_CH7, enable);
    } else if (sender() == ui->PB_InputMute_8) {
        _cfgItem->SetInputMute(ConfigItemAutomaticMixer::INPUT_CH8, enable);
    } else if (sender() == ui->PB_MixOutMute) {
        _cfgItem->SetMixOutMute(enable);
    }
}

void CfgSettingAutomaticMixerGainSharing8::dispAutomaticMixer(FC_RTU_AGS_METER *level)
{
    for (int i = 0; i < AUTOMIX_MAXCHANNEL; ++i)
    {
        ...
        if (level[i].modeUnitNum == _cfgItem->getModuleNum())
        {
            ...
            case 3:
                ...
                break;
            case 4:
                ui->Disp_Level_5->setLCurValue(vu);
                break;
            case 5:
                ui->Disp_Level_6->setLCurValue(vu);
                break;
            case 6:
                ui->Disp_Level_7->setLCurValue(vu);
                break;
            case 7:
                ui->Disp_Level_8->setLCurValue(vu);
                break;
            default:
                break;
            }
